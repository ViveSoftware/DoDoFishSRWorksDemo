...
// ------------------------------------------------------------------
// Compute energy flow visual effect.
sampler2D _EmissionMask;
float4 _EnergyFlowParams;
half3 ComputeEnergyFlow(float4 texcoord)
{
    // Compute energy flow UV.
    half2 maskUV = _EnergyFlowParams.xy + _EnergyFlowParams.z * texcoord.xy;
    return _EmissionColor * tex2D(_EmissionMap, texcoord.xy) * tex2D(_EmissionMask, maskUV).r;
}
// ------------------------------------------------------------------
