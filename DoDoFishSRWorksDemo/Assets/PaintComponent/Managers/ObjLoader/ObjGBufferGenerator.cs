...
//namespace PaintVR
//{
//    public class ObjGBufferGenerator : MonoBehaviour
//    {
//        // Class Definitions.
//        public class UVMesh
//        {
...
//        public GBufferResolution gBufferResolution = GBufferResolution.Medium;
...
//        // Unity Fixed Methods.
//        // ---------------------------------------------------------------
//        public void GBufferGeneratorInit(ref OBJLoader.OBJFace[] faceList, ref List<Vector2> uuvs, ref List<Vector3> uvertices, ref List<Vector3> unormals)
//        {
//            // Prepare GBuffer.
//            isGBufferReady = true;

//            // Generate render targets.
//            int texSize = GetGBufferSize(gBufferResolution);
...
//            // Generate UV meshes.
//            isGBufferReady &= GenerateGBufferMeshes(ref faceList, ref uuvs, ref uvertices, ref unormals);
...
//        void Update()
//        {
//            if (frameCount < 5 && isGBufferReady)
//            {
//                // Debug.Log("Update G Buffer");
//                RenderGBuffer();
//                frameCount++;
//            }
//            if (Input.GetKeyDown(KeyCode.S))
//            {
//                SaveGBufferToFile("test");
//            }
//        }

//        // Public Class Methods.
//        // ---------------------------------------------------------------
//        public bool SaveGBufferToFile(string fileName, bool isFullPath = false)
//        {
//            if (!isGBufferReady)
//            {
...
//        private bool GenerateGBufferMeshes(ref OBJLoader.OBJFace[] faceList, ref List<Vector2> uuvs, ref List<Vector3> uvertices, ref List<Vector3> unormals)
//        { 
//            CreateUVDataMesh(faceList, uuvs.ToArray(), uvertices.ToArray(), out posDataMeshes);
//            CreateUVDataMesh(faceList, uuvs.ToArray(), unormals.ToArray(), out normalDataMeshes);
//            return true;
//        }

//        private void CreateUVDataMesh(OBJLoader.OBJFace[] faceList, Vector2[] uvs, Vector3[] insertData, out Mesh[] outputMeshes)
//        {
//            // Get original mesh data.
//            int numTriangles = faceList.Length;
...
//            int numMeshes = Mathf.CeilToInt((float)faceList.Length * 3.0f / (float)UNITY_MAX_VERTICES);
...
//                int tid0 = faceList[triIndex].indexes[0];
//                int tid1 = faceList[triIndex].indexes[1];
//                int tid2 = faceList[triIndex].indexes[2];
