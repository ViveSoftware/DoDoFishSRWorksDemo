Shader "Custom/WriteDepthScreenStereo"
{
    Properties
    {
        ...
        _RenderOnRight("_LeftORight", Range(0, 1)) = 0.0
    }
        SubShader
    {
...
#include "UnityCG.cginc"
    ...
    sampler2D _MainTex;
    float4 _MainTex_ST;
    float _TestFactor, _MainCamNear, _MainCamFar, _RenderOnRight;
    ...
    {
		clip(unity_StereoEyeIndex != _RenderOnRight ? -1 : 1);
			//return 0;
